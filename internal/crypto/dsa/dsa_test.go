...
import (
	...
	"github.com/abaxxtech/abaxx-id-go/internal/crypto/dsa/ecdsa"
	"github.com/abaxxtech/abaxx-id-go/internal/crypto/dsa/eddsa"
...
func TestGeneratePrivateKeySECP256K1(t *testing.T) {
	...
	assert.Equal(t, ecdsa.SECP256K1JWACurve, privateJwk.CRV)
	assert.Equal(t, ecdsa.KeyType, privateJwk.KTY)
